...
FRISCTargetMachine::FRISCTargetMachine(const Target &T, const Triple &TT, StringRef CPU, StringRef FS,
    ...
    : LLVMTargetMachine(T, computeDataLayout(TT, CPU, Options), TT, CPU, FS, Options,
        getEffectiveRelocModel(TT, RM), CM, OL), Subtarget(TT, CPU, FS, *this),
