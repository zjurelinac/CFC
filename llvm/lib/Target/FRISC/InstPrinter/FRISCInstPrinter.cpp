...
void FRISCInstPrinter::printInst(const MCInst *MI, raw_ostream &O,
...
void FRISCInstPrinter::printOperand(const MCInst *MI, unsigned OpNo,
                                  raw_ostream &O) {
...
void FRISCInstPrinter::printMemSrcOperand(const MCInst *MI, unsigned OpNo,
                                           raw_ostream &O) {
